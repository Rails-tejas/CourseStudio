...
ActiveRecord::Schema[8.0].define(version: 2025_06_27_110805) do
  ...
  create_table "user_video_progresses", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "course_id", null: false
    t.string "video_id"
    t.boolean "completed"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["course_id"], name: "index_user_video_progresses_on_course_id"
    t.index ["user_id"], name: "index_user_video_progresses_on_user_id"
  end
  ...
  add_foreign_key "user_video_progresses", "courses"
  add_foreign_key "user_video_progresses", "users"
end
